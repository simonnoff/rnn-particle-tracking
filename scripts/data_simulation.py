...
def generate_point_track(index):
    storage_for_points_to_display = np.zeros((common.point_coordinates, number_of_time_steps))
    ...
    for i in range(number_of_time_steps):
        ...
        storage_for_points_to_display[0][i] = x_generated
        storage_for_points_to_display[1][i] = y_generated
    ...
    plt.plot(storage_for_points_to_display[0], storage_for_points_to_display[1], color=colors_array[index], linestyle='-')
